...
<div id="sidebar" class="mt-4" style="height: calc(100vh - 120px); overflow-y: auto; position: fixed; left: 0; top: 56px; bottom: 64px; width: 200px; padding-right: 15px;">
  ...
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('customer.php')"><i class="bi bi-people"></i> Customer Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('product.php')"><i class="bi bi-box"></i> Product Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('cart.php')"><i class="bi bi-cart"></i> Cart Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('order.php')"><i class="bi bi-receipt"></i> Order Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('delivery.php')"><i class="bi bi-truck"></i> Delivery Management</a></li>
<li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('payment.php')"><i class="bi bi-credit-card"></i> Payment Processing</a></li>
<li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('return.php')"><i class="bi bi-arrow-return-left"></i> Return Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('review.php')"><i class="bi bi-chat-left-text"></i> Customer Reviews</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('subscription.php')"><i class="bi bi-card-checklist"></i> Subscription Services</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('warehouse.php')"><i class="bi bi-house-door"></i> Warehouse Management</a></li>
    <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('category.php')"><i class="bi bi-tags"></i> Category Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('employee.php')"><i class="bi bi-person-workspace"></i> Employee Management</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('campaign.php')"><i class="bi bi-megaphone"></i> Marketing Campaigns</a></li>
  <li class="nav-item"><a class="nav-link" href="#" onclick="event.preventDefault(); loadContent('promotion.php')"><i class="bi bi-gift"></i> Promotion Management</a></li>
</ul>

  <!-- User Profile & Logout -->
  <div class="sidebar-footer pt-3">
    <ul class="nav flex-column">
      <li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('profile.php')"><i class="bi bi-person-circle"></i> User Profile</a></li>
